<template>
      ...
      <div class="grid sm:grid-cols-3 gap-16 px-5">
        <fade-in class="opacity-0">
          <ImageCard
            ...
            image-src="/images/landing/cover-programming.webp"
        ...
        <fade-in class="opacity-0" :delay="150">
          <ImageCard
            ...
            category-label="電子工作"
            image-src="/images/landing/cover-electronic.webp"
        ...
        <fade-in class="opacity-0" :delay="300">
          <ImageCard
            ...
            category-label="ガジェット/ハードウェア"
            image-src="/images/landing/cover-gadget.webp"
  ...
  <section class="relative w-full z-10" style="height: 83vh">
    <div class="container h-full relative mx-auto">
      <fade-in>
        <picture>
          <source type="image/webp" srcset="/images/landing/oucrc-room-label.webp" />
          <img
            class="oucrc-room-label absolute left-0"
            src="/images/landing/oucrc-room-label.webp"
            alt="電算研の部室"
          />
        </picture>
      </fade-in>
      ...
      <div class="lg:grid grid-cols-5 gap-20 px-6 sm:px-10 lg:px-0">
        <div class="col-span-2 image text-center">
          <NuxtLink to="/news/qbrftlmtqk">
            <picture>
              <source type="image/webp" srcset="/images/landing/shinkan.webp" />
              <img src="/images/landing/shinkan.png" alt="キャラ" />
            </picture>
          </NuxtLink>
        </div>
...
.parallax {
  background-image: url(/images/landing/oucrc-room.jpg);
}
</style>
