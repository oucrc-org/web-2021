    ...
    <NuxtLink v-bind:to="href"
      ...
      <div class="relative">
        ...
        <picture v-else>
          ...
          <img class="object-cover shadow-lg h-56 w-full" v-lazy="require('@/assets/images/article/cover.jpg')"
               alt="NoImage">
        </picture>
        <img class="absolute bottom-0 h-20 right-0" v-lazy="require('@/assets/images/common/polygon.svg')"
             alt="Polygon">
