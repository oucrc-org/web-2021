    ...
    <div class="md:container xl:mx-auto">
      <div class="form">
        ...
        <div class="text-left mb-6 mt-8">
          <img class="inline h-6" src="/images/landing/contact-mail.svg" alt="Mail" />
          <a
            href="mailto:oucrc.master@gmail.com"
            class="font-semibold ml-4 text-secondary tracking-widest"
          >
        ...
        <div class="text-left my-6">
          <img class="inline h-6" src="/images/landing/contact-twitter.svg" alt="Twitter" />
          <a
        ...
        <div class="text-left mb-8 mt-6">
          <img class="inline h-6" src="/images/landing/contact-google-form.svg" alt="GoogleForm" />
