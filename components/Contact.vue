    ...
    <div class="md:container xl:mx-auto">
      <div class="form">
        ...
        <div class="text-left mb-6 mt-8">
          <img
            class="inline h-6"
            v-lazy="require('@/assets/images/landing/contact-mail.svg')"
            alt="Mail"
          />
          <a
        ...
        <div class="text-left my-6">
          <img
            class="inline h-6"
            v-lazy="require('@/assets/images/landing/contact-twitter.svg')"
            alt="Twitter"
          />
          <a
        ...
        <div class="text-left mb-8 mt-6">
          <img
            class="inline h-6"
            v-lazy="require('@/assets/images/landing/contact-google-form.svg')"
            alt="GoogleForm"
          />
