<template>
  <label :for="id" class="cursor-pointer font-semibold inline-block text-sm mr-3 mb-3 py-2 pl-3 pr-5 rounded-md"
    ...
    <img class="inline h-6 mr-2"
         v-lazy="name === 'category' ? ( checked ? require('@/assets/images/article/category-checked.svg') : require('@/assets/images/article/category.svg') ) : ( checked ? require('@/assets/images/article/series-checked.svg') : require('@/assets/images/article/series.svg') )"
         alt="Image">
